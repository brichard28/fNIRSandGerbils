...
# Read the .mat file
library(R.matlab)
p1_data <- read.csv('C:\\Users\\benri\\Documents\\GitHub\\fNIRSandGerbils\\data\\all_subs_p1_exp2.csv')
n1_data <- read.csv('C:\\Users\\benri\\Documents\\GitHub\\fNIRSandGerbils\\data\\all_subs_n1_exp2.csv')
p2_data <- read.csv('C:\\Users\\benri\\Documents\\GitHub\\fNIRSandGerbils\\data\\all_subs_p2_exp2.csv')
p3_data <- read.csv('C:\\Users\\benri\\Documents\\GitHub\\fNIRSandGerbils\\data\\all_subs_p3_exp2.csv')
