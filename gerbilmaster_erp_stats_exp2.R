...
# Read the .mat file
library(R.matlab)
p1_data <- read.csv('/Users/benrichardson/Documents/GitHub/fNIRSandGerbils/data/all_subs_p1_target_exp2_incl_resp.csv')
n1_data <- read.csv('/Users/benrichardson/Documents/GitHub/fNIRSandGerbils/data/all_subs_n1_target_exp2_incl_resp.csv')
p2_data <- read.csv('/Users/benrichardson/Documents/GitHub/fNIRSandGerbils/data/all_subs_p2_target_exp2_incl_resp.csv')
p3_data <- read.csv('/Users/benrichardson/Documents/GitHub/fNIRSandGerbils/data/all_subs_p3_target_exp2_incl_resp.csv')
