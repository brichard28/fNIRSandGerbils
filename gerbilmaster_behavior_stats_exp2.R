...
# plot and conduct statistics for scrambled speech behavior experiment 2
...
posthoc_talker_scrambled_exp2 <- lmer(DPrime ~ Talker + (1|S),
                                 data= subset(d_primes, Masker == "Scrambled"), 
                                 control = lmerControl(optimizer = "bobyqa"))

summary(posthoc_talker_scrambled_exp2)

posthoc_talker_unscrambled_exp2 <- lmer(DPrime ~ Talker + (1|S),
